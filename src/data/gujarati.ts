...
export const words: WordItem[] = [
  ...
  { gujarati: 'ટમેટા', roman: 'tameta', english: 'Tomato', category: 'food', level: 1 },
  ...
  { gujarati: 'ઘારી', roman: 'ghari', english: 'Ghari (Surat’s festive sweet)', category: 'surat', level: 1 },
  { gujarati: 'સેવ ખમણી', roman: 'sev khamani', english: 'Sev Khamani (savory snack)', category: 'surat', level: 1 },
  { gujarati: 'પોંક', roman: 'ponk', english: 'Ponk (roasted green millet)', category: 'surat', level: 2 },
  { gujarati: 'રેશમ', roman: 'resham', english: 'Silk', category: 'surat', level: 1 },
  { gujarati: 'ઝરી', roman: 'zari', english: 'Zari (gold thread embroidery)', category: 'surat', level: 2 },
  { gujarati: 'વણકર', roman: 'vankar', english: 'Weaver', category: 'surat', level: 2 },
  { gujarati: 'કારીગર', roman: 'karigar', english: 'Craftsman', category: 'surat', level: 2 },
  { gujarati: 'ઉદ્યોગ', roman: 'udyog', english: 'Industry', category: 'surat', level: 2 },
  { gujarati: 'કારખાનું', roman: 'karkhanu', english: 'Factory', category: 'surat', level: 2 },
  { gujarati: 'દરિયાકિનારો', roman: 'dariyakinaro', english: 'Seashore', category: 'surat', level: 2 },
  { gujarati: 'દુમસ', roman: 'dumas', english: 'Dumas (black-sand beach)', category: 'surat', level: 1 },
  { gujarati: 'કિલ્લો', roman: 'killo', english: 'Fort', category: 'surat', level: 1 },
  { gujarati: 'પુલ', roman: 'pul', english: 'Bridge', category: 'surat', level: 1 },
  { gujarati: 'બંદર', roman: 'bandar', english: 'Port / Harbor', category: 'surat', level: 2 },
  { gujarati: 'હજીરા', roman: 'hazira', english: 'Hazira (port town)', category: 'surat', level: 2 },
  { gujarati: 'મંદિર', roman: 'mandir', english: 'Temple', category: 'surat', level: 1 },
  { gujarati: 'દેરાસર', roman: 'derasar', english: 'Jain Temple', category: 'surat', level: 2 },
  { gujarati: 'બગીચો', roman: 'bagicho', english: 'Garden', category: 'surat', level: 1 },
  { gujarati: 'પ્રાણી સંગ્રહાલય', roman: 'prani sangrahalay', english: 'Zoo', category: 'surat', level: 2 },
  { gujarati: 'વિજ્ઞાન કેન્દ્ર', roman: 'vigyan kendra', english: 'Science Centre', category: 'surat', level: 2 },
  { gujarati: 'બજાર', roman: 'bajaar', english: 'Market', category: 'surat', level: 1 },
  { gujarati: 'ગલી', roman: 'gali', english: 'Lane / Street', category: 'surat', level: 1 },
  { gujarati: 'નાકા', roman: 'naka', english: 'Crossroad / Junction', category: 'surat', level: 2 },
  { gujarati: 'સુરતી', roman: 'surati', english: 'Surati (person/dialect)', category: 'surat', level: 2 },
  { gujarati: 'ઘાટ', roman: 'ghat', english: 'River Ghat (steps)', category: 'surat', level: 2 },
...
export const stories: StoryItem[] = [
...

  {
    ...
    level: 2,
    lines: [
      { gujarati: 'વાંદરો નદીકાંઠે ઝાડ પર રહેતો હતો.', roman: 'vandro nadi kaanthe jhad par raheto hato.', english: 'A monkey lived in a tree by the riverbank.' },
      { gujarati: 'તેણે મગર સાથે મિત્રતા કરી અને તેને મીઠાં ફળ આપ્યાં.', roman: 'tene magar sathe mitrata kari ane tene mithaa fal aapyaa.', english: 'He became friends with a crocodile and gave him sweet fruits.' },
      { gujarati: 'મગરની પત્નીને ફળ ખૂબ ગમ્યાં, તેણે વાંદરાનું હૃદય માગ્યું.', roman: 'magarni patnine fal khoob gamyaa, tene vandarnu hruday maagyu.', english: 'The crocodile’s wife loved the fruit and demanded the monkey’s heart.' },
      { gujarati: 'મગર વાંદરાને પોતાની પીઠ પર બેસાડી નદી પાર લઈ ગયો.', roman: 'magar vandarane potani peeth par besadi nadi paar lai gayo.', english: 'The crocodile carried the monkey on his back across the river.' },
      { gujarati: 'વચ્ચે પહોંચતા મગરે સાચું કારણ કહી દીધું.', roman: 'vachche pahonchta magare sachu kaaran kahi didhu.', english: 'Halfway across, the crocodile revealed the real reason.' },
      { gujarati: 'વાંદરાએ ચતુરાઈથી કહ્યું, "મારું હૃદય તો ઝાડ પર જ રહી ગયું છે!"', roman: 'vandaraye chaturaithi kahyu, "maru hruday to jhad par ja rahi gayu chhe!"', english: 'The clever monkey said, "My heart is still back on the tree!"' },
      { gujarati: 'મગર તેને પાછો કિનારે લઈ ગયો.', roman: 'magar tene paachho kinare lai gayo.', english: 'The crocodile took him back to the riverbank.' },
      { gujarati: 'વાંદરો તરત ઝાડ પર કૂદી ગયો અને મિત્રતા તોડી નાખી.', roman: 'vandro tarat jhad par koodi gayo ane mitrata todi nakhi.', english: 'The monkey jumped onto the tree at once and ended the friendship.' },
    ],
    focusWords: [
      { gujarati: 'વાંદરો', roman: 'vandro', english: 'monkey' },
      { gujarati: 'મગર', roman: 'magar', english: 'crocodile' },
      { gujarati: 'હૃદય', roman: 'hruday', english: 'heart' },
      { gujarati: 'નદી', roman: 'nadi', english: 'river' },
    ],
    moralGujarati: 'ચતુરાઈ અને સાવધાની તમને બચાવી શકે છે.',
    moralEnglish: 'Cleverness and caution can save you.',
    questionGujarati: 'વાંદરાએ મગરને શું ચતુરાઈભર્યું બહાનું આપ્યું?',
    questionEnglish: 'What clever excuse did the monkey give the crocodile?',
  },
